                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Text('REVISED v2', style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold)),
                      ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: const Text('v1 Original', style: TextStyle(color: Colors.white, fontSize: 12)),
                              ),
                            ),
                          ],
                        ),
                      ...
                      const SizedBox(height: 8),
                      const Text('SUBMITTED JULY 12', style: TextStyle(fontSize: 12, color: AppColors.textSecondary, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              child: Container(
                                padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                                color: Colors.green.shade700,
                                child: const Text('v2 Revised', style: TextStyle(color: Colors.white, fontSize: 12)),
                              ),
                            ),
                          ],
                        ),
                      ...
                      const SizedBox(height: 8),
                      const Text('LATEST REVISION', style: TextStyle(fontSize: 12, color: AppColors.textPrimary, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              ],
              ...
              Padding(
                ...
                child: Row(
                   ...
                   children: [
                      ...
                      Text(time, style: const TextStyle(fontSize: 12, color: AppColors.placeholder)),
                   ],
                ),
              ),
              const SizedBox(height: 4),
